...
typedef enum as_EObjTypeFlags {
	...
	AS_OBJ_APP_CLASS_CDA              = (AS_OBJ_APP_CLASS + AS_OBJ_APP_CLASS_CONSTRUCTOR + AS_OBJ_APP_CLASS_DESTRUCTOR + AS_OBJ_APP_CLASS_ASSIGNMENT),
	AS_OBJ_APP_CLASS_CDK              = (AS_OBJ_APP_CLASS + AS_OBJ_APP_CLASS_CONSTRUCTOR + AS_OBJ_APP_CLASS_DESTRUCTOR + AS_OBJ_APP_CLASS_COPY_CONSTRUCTOR),
	AS_OBJ_APP_CLASS_CAK              = (AS_OBJ_APP_CLASS + AS_OBJ_APP_CLASS_CONSTRUCTOR + AS_OBJ_APP_CLASS_ASSIGNMENT + AS_OBJ_APP_CLASS_COPY_CONSTRUCTOR),
	AS_OBJ_APP_CLASS_CDAK             = (AS_OBJ_APP_CLASS + AS_OBJ_APP_CLASS_CONSTRUCTOR + AS_OBJ_APP_CLASS_DESTRUCTOR + AS_OBJ_APP_CLASS_ASSIGNMENT + AS_OBJ_APP_CLASS_COPY_CONSTRUCTOR),
	...
	AS_OBJ_APP_CLASS_DAK              = (AS_OBJ_APP_CLASS + AS_OBJ_APP_CLASS_DESTRUCTOR + AS_OBJ_APP_CLASS_ASSIGNMENT + AS_OBJ_APP_CLASS_COPY_CONSTRUCTOR),
...
public:
	...
	virtual int    GetGlobalPropertyByIndex(asUINT index, const char **name, const char **nameSpace = 0, int *typeId = 0, bool *isConst = 0, const char **configGroup = 0, void **pointer = 0, as_DWORD *accessMask = 0) const = 0;
...
public:
	...
	// Properties
	virtual asUINT      GetPropertyCount() const = 0;
	virtual int         GetProperty(asUINT index, const char **name, int *typeId = 0, bool *isPrivate = 0, bool *isProtected = 0, int *offset = 0, bool *isReference = 0, as_DWORD *accessMask = 0, int *compositeOffset = 0, bool *isCompositeIndirect = 0) const = 0;
...
public:
	...
	virtual int              GetParam(asUINT index, int *typeId, as_DWORD *flags = 0, const char **name = 0, const char **defaultArg = 0) const = 0;
	virtual int              GetReturnTypeId(as_DWORD *flags = 0) const = 0;
